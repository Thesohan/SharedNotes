...
exports.finalNoticeRequestPushNotification = functions.database.ref('{collegeName}/Requests/{schoolName}/{pushId}')
.onCreate( (snapshot,context) => {
console.log('Push notification event triggered for notice requests');
...
/* Create a notification and data payload. They contain the notification information, and message to be sent respectively */
    const payload = {
        notification: {
            title: 'There is a new notice request in '+schoolName,
