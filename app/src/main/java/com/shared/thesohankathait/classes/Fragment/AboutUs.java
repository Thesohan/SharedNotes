...
import com.shared.thesohankathait.classes.ViewHolders.AboutUmangViewHolder;
import com.shared.thesohankathait.classes.model.AboutUmang_model;
...
//        initialising
    ...
    private void fetchAboutFromFirebase() {
        ...
        firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<AboutUmang_model,
                ...
                AboutUmangViewHolder.class,FirebaseDatabase.getInstance().getReference("AboutUs")) {
            @Override
    ...
    private void deleteFromFirebase(final AboutUmang_model aboutUmang_model) {
        ...
        FirebaseDatabase.getInstance().getReference("AboutUs").addChildEventListener(new ChildEventListener() {
            @Override
    ...
    private void uploadintoFirebase() {
       ...
       FirebaseDatabase.getInstance().getReference("AboutUs").push().setValue(aboutUmang_model).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
