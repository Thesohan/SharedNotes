...
import com.shared.thesohankathait.notices.javas.Adapter.RequestPdfNoticeArrayAdapter;
...
import com.shared.thesohankathait.notices.javas.ViewHolders.PdfNoticesViewHolder;
...
//
                pdfNoticesViewHolder.pdfNotificationlinearLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        PdfDownloadTask.DownloadData(getContext(),notices.getImageUrl(),
                                notices.getTitle());
//
//
                        //download pdf
